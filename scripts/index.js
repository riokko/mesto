...
function editProfilePopupOpen() {
  ...
  const popupAddFormValidator = new FormValidator(editProfilePopup, classesMap);
...
function openPhotoPopupWithData(event) {
...
elementsList.addEventListener('click', openPhotoPopupWithData);
